...
public abstract class SniperAbs extends Weapon {


    protected int weaponsize = 4;
    ...
    public Weapon getLevelWeapon(int level,GameModel model){
        switch (level){
            case 1:return new Sniper(model);
            case 2:return new HeavySniper(model);
            case 3:return new OneShot(model);
            default:return null;
        }
    }
